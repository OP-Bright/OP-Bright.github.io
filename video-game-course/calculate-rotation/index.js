...
(function (window, opspark, inefficiencyJS) {
  ...
  function update(event) {
    ...
    const angleFromShip = inefficiencyJS.numz.getAngleDegrees(ship, mouse);

    // TODO 8: Set the ship's rotation property to the degrees //

    ship.rotation = angleFromShip;
    ...
    assets.updateText(
      textfield,
      `Degrees: ${angleFromShip.toFixed(3)}°`,
      canvas
    );
  }
...
})(window, window.opspark, window.inefficiencyJS);
